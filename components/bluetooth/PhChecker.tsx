...
export default function PoultryPHInputScreen() {
  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      <TopNavigation />
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={tw`bg-white py-30 h-full`}>
          ...
          {!submitted ? (
            <>
              ...
              <Animated.View style={{
                ...
                <TouchableOpacity
                  style={tw`py-5 px-8 bg-orange-600 rounded-2xl flex justify-center items-center`}
                  onPress={handleSubmit}
                >
                  <Text style={tw`text-white font-semibold`}>Submit Reading</Text>
                </TouchableOpacity>
              </Animated.View>
            </>
          ) : (
            <>
              ...
              {submitted && (
                <Animated.View style={{
                  ...
                  <TouchableOpacity
                    style={tw`py-5 px-10 bg-orange-600 rounded-2xl flex justify-center items-center`}
                    onPress={handleReset}
                  >
                    <Text style={tw`text-white font-semibold `}>Check Another Reading</Text>
                  </TouchableOpacity>
                </Animated.View>
              )}
            </>
