        ...
        <>
            ...
            <View style={tw`absolute bottom-0 left-0 right-0 flex-row justify-around items-center bg-white py-3 border-t border-gray-100 shadow-md rounded-t-2xl `
                ...
                <TouchableOpacity onPress={() => router.navigate('News')} style={tw`items-center `}>
                    <View style={tw`w-12 h-12 rounded-full items-center justify-center  ${isCurrentScreen('Home') ? ' bg-red-600 shadow-md' : 'black'}`}>
                        <Ionicons name="home" size={28} color={`${isCurrentScreen('Home') ? 'white' : 'black'}`} />
                    </View>
                ...
                <TouchableOpacity onPress={() => router.navigate('Pairing')} style={tw`items-center`}>
                    <View style={tw`w-12 h-12 rounded-full items-center justify-center  ${isCurrentScreen('Pairing') ? ' bg-red-600 shadow-md' : 'black'}`}>
                ...
                <TouchableOpacity onPress={() => router.navigate('News')} style={tw`items-center`}>
                    <View style={tw`w-12 h-12 rounded-full items-center justify-center  ${isCurrentScreen('News') ? ' bg-red-600 shadow-md' : 'black'}`}>
                ...
                <TouchableOpacity onPress={() => router.navigate('Settings')} style={tw`items-center`}>
                    <View style={tw`w-12 h-12 rounded-full items-center justify-center  ${isCurrentScreen('Settings') ? ' bg-red-600 shadow-md' : 'black'}`}>
